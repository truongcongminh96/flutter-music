...
class _RadioFmState extends State<RadioFm> {
  ...
  setupAlan() {
    AlanVoice.addButton(
        "1e0889c5b70ef54c5f2a8191d642c5e92e956eca572e1d8b807a3e2338fdd0dc/stage",
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          [
            AppBar(
              title: "Night City Radio".text.xl4.bold.white.make().shimmer(
